...
namespace Bygdrift.Warehouse.DataLakes
{
    ...
    {
        //public static void SaveCsv(this DataLake dataLake, string table, string folderName, Csv csv)
        //{
        ...
        public static void SaveCsv(this DataLake dataLake, string basePath, string fileName, Csv csv)
        {
        ...
        public static void SaveCsvToDateTimeFolder(this DataLake dataLake, string basePath, string table, Csv csv, DateTime fileDate, bool savePerHour, bool onlyOverwriteIfFileIsNewer = true)
        {
            var filename = table + ".csv";
